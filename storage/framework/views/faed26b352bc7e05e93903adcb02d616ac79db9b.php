...
<?php $__env->startSection('title', 'Tambah Seminar'); ?>
    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-header">
                <h4><i class="fas fa-plus"></i> Tambah Seminar Baru</h4>
            </div>
            <div class="card-body">
                <form action="<?php echo e(route('seminars.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="time" name="time" value="<?php echo e(old('time')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="<?php echo e(route('seminars.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pendaftaran-seminar\resources\views/seminars/create.blade.php ENDPATH**/ ?>