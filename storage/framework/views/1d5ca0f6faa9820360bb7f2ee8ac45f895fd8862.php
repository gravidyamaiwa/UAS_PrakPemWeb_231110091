...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $seminars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seminar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($seminar->id); ?>" <?php echo e(old('seminar_id') == $seminar->id ? 'selected' : ''); ?>>
                                        <?php echo e($seminar->title); ?> - <?php echo e($seminar->date->format('d/m/Y')); ?> - 
                                        Rp <?php echo e(number_format($seminar->price, 0, ',', '.')); ?>

                                        (Sisa: <?php echo e($seminar->available_slots); ?> slot)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?php echo e(route('participants.index')); ?>" class="btn btn-secondary me-md-2">
                                Kembali
                            </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pendaftaran-seminar\resources\views/participants/create.blade.php ENDPATH**/ ?>